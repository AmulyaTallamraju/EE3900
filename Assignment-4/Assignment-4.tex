...
\begin{multline}
    c=n_1(a_1+\lambda(b_1-a_1))\\+n_2(a_2+\lambda(b_2-a_2))\\+n_3(a_3+\lambda(b_3-a_3))\\
\end{multline}   
\begin{align}   
    \implies \lambda=\frac{c-n_1a_1-n_2a_2-n_3a_3}{n_1(b_1-a_1)+n_2(b_2-a_2)+n_3(b_3-a_3)}
\end{align}
The point of intersection is then given by
\begin{align}
    \vec{x}=\myvec{a_1+\lambda b_1\\a_2+\lambda b_2\\a_3+\lambda b_3}
\end{align}
For the given problem,
\begin{align}
\myvec{a_1\\a_2\\a_3}= \myvec{5\\1\\6} \\
\myvec{b_1\\b_2\\b_3}= \myvec{2\\-3\\5}\\
\myvec{n_1\\n_2\\n_3}=\myvec{1\\0\\0}\\
    c=0
\end{align}

...
a^b\sum _{n=-f }^{\infty }\brak{{az^{-1}}}^n  
=a^b\brak{{\brak{\frac{z}{a}}^f}({1-az^{-1}})^{-1}}
\end{align}
provided, $\abs{a}<\abs{z}$, which is the region of convergence.When $d=-n$ is given by
\begin{align}\label{Z2}
a^b\sum _{n=-\infty }^{f }\brak{az^{-1}}^n 
&=a^b\sum _{n=-f }^{\infty }\brak{az^{-1}}^{-n}\\
&=a^b\sum _{n=-f }^{\infty }\brak{\frac{z}{a}}^n\\
&=a^b\brak{{\brak{az^{-1}}^f}\brak{1-\frac{z}{a}}^{-1}}
\end{align}
...
\begin{align}
    Y(z=e^{j\omega})&={\mathcal {Z}}\{y[n]\}=4\brak{{2z}\brak{1-\frac{z^{-1}}{2}}^{-1}}
\end{align}
Now,
\begin{align}
...
\begin{multline}
  Z(z=e^{j\omega})=\\2 \brak{2z^{-1}}^3\brak{1+2\brak{\frac{z}{2}}+3\brak{\frac{z}{2}}^2+4\brak{\frac{z}{2}}^3 \ldots}\label{1}
\end{multline}
